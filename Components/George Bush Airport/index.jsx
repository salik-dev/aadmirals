              ...
              <Container>
                ...
                <Row className={styles.logoContainer}>
                  <Col xs={12} xl={12} md={12} className={styles.heading1}>
                     <Image priority={true} src="/Assets/Group 943.png" alt="AAdmirals Travel & Transportation" width={100} height={70} objectFit="fill"  quality={100} />
                    <h2>
                ...
                <Row>
                  <Col xs={12} xl={12} md={12}>
                     <Image priority={true} alt="Car Service from IAH Airport" src={data.bannerImage} width={100} height={40} layout="responsive"  quality={100} />
                  </Col>
                </Row>
                <Row>
                  <Col
                  ...
                  <Col xs={12} xl={12} md={12} style={{ paddingTop: "50px" }}>
                     ...
                     <Image priority={true} alt="Shuttle from IAH Airport" src={data.IahairportImage} width={100} height={40} layout="responsive"  quality={100} />
              ...
              <h6 style={{ fontSize: "17px", fontFamily: "ProximaNovaLight" }}>
                ...
                <Row style={{ paddingTop: "100px" }}>
                  ...
                  <Col xl={6} xs={12} className={styles.imageContainer1}>
                     ...
                     <Image priority={true} src={data.ourFleetImage} alt="George Bush Limo Service"    width={800} height={590} quality={100}  objectFit="cover"/>
                  </Col>
                </Row>
                <Row style={{ paddingTop: "100px" }}>
                  <Col xl={6} md={12} xs={12} className={styles.discription1}>
                  ...
                  <Col xl={6} xs={12} className={styles.imageContainer1}>
                     ...
                     <Image priority={true} src={data.IahairportinfoImage} alt="George Bush Airport View"    width={800} height={590} quality={100}  objectFit="cover"/>
