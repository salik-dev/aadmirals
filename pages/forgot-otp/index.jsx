...
import { forgotOTPAction } from "../../redux/Auth2/forgotOTP/action/action";
...
const Forgot = ({ history }) => {
  ...
  const otp = useSelector((state) => state.forgotOTP);
  const { loading, error } = otp;

  const submitHandler = (e) => {
    e.preventDefault();

    dispatch(forgotOTPAction(email, verificationCode, Router));
  };
